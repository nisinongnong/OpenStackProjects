...
import com.jzby.tigervnc.rdr.OutStream;
...
abstract public class CConnection extends CMsgHandler {
    ...
    private void securityCompleted() {
        ...
        reader_ = new CMsgReaderV3(this, is, viewer);
    ...
    public void setProtocol3_3(boolean s) {
        useProtocol3_3 = s;
    }
    ...
    public static void setSocket(java.net.Socket sock_) {
        sock = sock_;
    }
