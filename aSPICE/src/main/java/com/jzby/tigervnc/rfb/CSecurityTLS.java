...
public class CSecurityTLS extends CSecurity {
    ...
    public static final StringParameter x509ca
            = new StringParameter("x509ca", "X509 CA certificate", ""); //"/system/etc/security/cacerts.bks");
    public static final StringParameter x509crl
            = new StringParameter("x509crl", "X509 CRL file", "");
        ...
        MyX509TrustManager() throws java.security.GeneralSecurityException {
            ...
            try {
                ...
                if (!crlcert.exists() || !crlcert.canRead()) {
                    ...
                    crlStream = new FileInputStream(crlfile);
