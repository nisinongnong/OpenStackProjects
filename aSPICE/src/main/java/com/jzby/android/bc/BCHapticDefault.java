...
class BCHapticDefault implements IBCHaptic {
    ...
    /* (non-Javadoc)
     * @see com.jzby.android.bc.IBCHaptic#performLongPressHaptic(android.view.View)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.jzby.android.bc.IBCHaptic#setIsHapticEnabled(android.view.View, boolean)
     */
/*
 *     @Override
