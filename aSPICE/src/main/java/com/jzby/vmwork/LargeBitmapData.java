...
import com.jzby.android.drawing.OverlappingCopy;
import com.jzby.android.drawing.RectList;
import com.jzby.util.ObjectPool;
...
class LargeBitmapData extends AbstractBitmapData {
    ...
    static String TAG=LargeBitmapData.class.getSimpleName();
    ...
    class LargeBitmapDrawable extends AbstractBitmapDrawable {
        ...
        public void draw(Canvas canvas) {
            Log.i(TAG, "Drawing "+xoffset+" "+yoffset);
            int xoff, yoff;
    ...
    /* (non-Javadoc)
     * @see com.jzby.bVNC.AbstractBitmapData#offset(int, int)
     */
    @Override
    ...
    public void updateBitmap(int x, int y, int w, int h) {
        ...
        Log.i(TAG,"======updateBitmap()===="+x+"===="+y+"==="+w+"====="+h);
    ...
    /* (non-Javadoc)
     * @see com.jzby.bVNC.AbstractBitmapData#validDraw(int, int, int, int)
     */
    @Override
    public synchronized boolean validDraw(int x, int y, int w, int h) {
        ...
        Log.e(TAG, "Validate Drawing x:"+x+" y:"+y+" w:"+w+" h:"+h+" xoff:"+xoffset+" yoff:"+yoffset+" "+(x-xoffset>=0 && x-xoffset+w<=bitmapwidth && y-yoffset>=0 && y-yoffset+h<=bitmapheight));
    ...
    /* (non-Javadoc)
     * @see com.jzby.bVNC.AbstractBitmapData#prepareFullUpdateRequest(boolean)
     */
    @Override
    ...
    synchronized void syncScroll() {
        ...
        Log.i(TAG, "pending "+pendingList.toString() + "invalid "+invalidList.toString());
    }
