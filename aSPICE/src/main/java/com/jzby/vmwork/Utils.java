...
public class Utils {
    ...
    public static void showErrorMessage(Context _context, String message) {
        showMessage(_context, _context.getString(R.string.error_text), message, android.R.drawable.ic_dialog_alert, null);
    }

    public static void showFatalErrorMessage(final Context _context, String message) {
        showMessage(_context, _context.getString(R.string.error_text), message, android.R.drawable.ic_dialog_alert, new View.OnClickListener() {
    ...
    public static void showMessage(Context _context, String title, String message, int icon, View.OnClickListener ackHandler) {

        MyDialog alertDialog = new MyDialog(_context);
        boolean show = true;
        if (_context instanceof Activity) {
            Activity activity = (Activity) _context;
            if (activity.isFinishing()) {
        ...
        if (show) {
            ...
            //    alertDialog.setPositiveButton(R.string.acknowledged_text, ackHandler);
            String acknowledged_text = _context.getString(R.string.acknowledged_text);
            alertDialog.setButton(acknowledged_text, ackHandler);
        }
    }
