...
abstract public class AbstractBitmapData {
    ...
    int bitmapheight;
    RfbConnectable rfb;
    Bitmap mbitmap;//save virture computer picture
    int bitmapPixels[];
    Canvas memGraphics;
    ...
    public boolean showCursorFlag=false;//xpz control apk mouse show or hidden
     ...
     *  src Rectangle in full-frame coordinates to be copied
     *  dest Destination rectangle in full-frame coordinates
     *  paint Paint specifier
     */
