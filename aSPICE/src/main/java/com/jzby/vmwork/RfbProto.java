...
import com.jzby.vmwork.CapabilityInfo;
import com.jzby.vmwork.CapsContainer;
import com.jzby.vmwork.R;
    ...
    int selectSecurityType(int bitPref, int connType) throws Exception {
        ...
        for (int i = 0; i < nSecTypes; i++) {
            ...
            if (connType == Constants.CONN_TYPE_ANONTLS) {
                ...
                // since Anon DH ciphers are deprecated in API >= 23    xpz
               /* if (currentapiVersion < android.os.Build.VERSION_CODES.M && secTypes[i] == SecTypeTLS) {
                ...
                if (currentapiVersion < 23 && secTypes[i] == SecTypeTLS) {
                    secType = secTypes[i];
                    break;
                } else if (currentapiVersion >= 23 && secTypes[i] == SecTypeTLS) {
                    secTypeTlsAndNewSdk = true;
                }
