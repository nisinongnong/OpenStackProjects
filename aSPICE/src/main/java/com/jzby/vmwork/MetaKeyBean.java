...
import com.jzby.vmwork.input.RemoteVncPointer;
...
public class MetaKeyBean extends AbstractMetaKeyBean implements Comparable<MetaKeyBean> {
    ...
    /* (non-Javadoc)
     * @see com.jzby.bVNC.AbstractMetaKeyBean#getKeyDesc()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.jzby.bVNC.AbstractMetaKeyBean#setKeyDesc(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.jzby.bVNC.AbstractMetaKeyBean#setKeySym(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.jzby.bVNC.AbstractMetaKeyBean#setMetaFlags(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.jzby.bVNC.AbstractMetaKeyBean#setMouseButtons(int)
     */
    @Override
