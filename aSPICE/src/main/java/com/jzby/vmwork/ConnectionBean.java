...
//        setRotateDpad(false);
    ...
    void parseFromUri(Uri dataUri,Context context) {
        ...
        if (extraKeysToggleParam != null)
            setExtraKeysToggleType(Integer.parseInt(extraKeysToggleParam));
