...
public class Constants {
    public static final String CONNECTION = "com.jzby.bVNC.CONNECTION";
    ...
    public static final String SERVER_STATUS_REBOOT="REBOOT";
    public static final String SERVER_STATUS_BUILD="BUILD";
    public static final String SERVER_STATUS_SHUTOFF="SHUTOFF";
    ...
    public static final int REMOTE_VIEW_CLOSE=400;
    ...
    public final static String COMMAND_AUTO_X_CREATE_XVFB_STRING = "sh -context \"PORT= x11vnc -norc -nopw -wait_ui 2 -defer 15 -wait 15 -ncache 0 -timeout 10 -create -localhost ";
    public final static String COMMAND_AUTO_X_CREATE_XVNC_STRING = "sh -context \"PORT= x11vnc -norc -nopw -wait_ui 2 -defer 15 -wait 15 -ncache 0 -timeout 10 -create -localhost -xvnc ";
    public final static String COMMAND_AUTO_X_CREATE_XDUMMY_STRING = "sh -context \"PORT= x11vnc -norc -nopw -wait_ui 2 -defer 15 -wait 15 -ncache 0 -timeout 10 -create -localhost -xdummy ";
    public final static String COMMAND_AUTO_X_FIND_STRING = "sh -context \"PORT= x11vnc -norc -nopw -wait_ui 2 -defer 15 -wait 15 -ncache 0 -timeout 10 -find   -localhost ";
    public final static String COMMAND_AUTO_X_SUDO_FIND_STRING = "sh -context \"PORT= sudo -S x11vnc -norc -nopw -wait_ui 2 -defer 15 -wait 15 -ncache 0 -timeout 10 -find -localhost -env FD_XDM=1 ";
    ...
    public static final String DEFAULT_LAYOUT_MAP = "English (JZ)";
    ...
    public static final String ACTION_USB_PERMISSION = "com.jzby.vmwork.USB_PERMISSION";
