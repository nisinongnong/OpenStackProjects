...
public class GetTextFragment extends DialogFragment {
    public static final String TAG = "GetTextFragment";
    ...
    public void setTextFragmentListener(OnFragmentDismissedListener dismissalListener)
    {
        this.dismissalListener = dismissalListener;
    }
    ...
    public static GetTextFragment newInstance(String title, OnFragmentDismissedListener dismissalListener,
        ...
        f.setTextFragmentListener(dismissalListener);
    ...
    public void onDismiss(DialogInterface dialog) {
        ...
        if (wasCancelled || TextUtils.isEmpty(result)) {
            wasCancelled = true;
            result = "";
        }
