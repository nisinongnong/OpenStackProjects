...
public class TouchMouseSwipePanInputHandler extends AbstractGestureInputHandler {
     ...
     * (non-Javadoc)
     * 
     * @see com.jzby.bVNC.AbstractInputHandler#getHandlerDescription()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.jzby.bVNC.AbstractInputHandler#getName()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.jzby.bVNC.VncCanvasActivity.ZoomInputHandler#onKeyDown(int,
     ...
     * (non-Javadoc)
     * 
     * @see com.jzby.bVNC.VncCanvasActivity.ZoomInputHandler#onKeyUp(int,
     *      android.view.KeyEvent)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.jzby.bVNC.AbstractInputHandler#onTrackballEvent(android.view.MotionEvent)
     */
    @Override
