...
public abstract class RemoteKeyboard {
    ...
    public final static int SCAN_BACKSPACE = 57; // JCK add
    ...
    public final static int CTRL_MASK = KeyEvent.META_SYM_ON; // 4
    public final static int SHIFT_MASK = KeyEvent.META_SHIFT_ON; // 1
    public final static int ALT_MASK = KeyEvent.META_ALT_ON; // 2
    public final static int SUPER_MASK = 0x8;
    public final static int RCTRL_MASK = KeyEvent.META_CTRL_RIGHT_ON; //16384
    public final static int RSHIFT_MASK = KeyEvent.META_SHIFT_RIGHT_ON;//128
    public final static int RALT_MASK = 0x10;
    public final static int RSUPER_MASK = KeyEvent.META_META_RIGHT_ON; // 262144
    //xpz
    public final static int NUMLOCK_MASK = KeyEvent.META_NUM_LOCK_ON;//2097152
