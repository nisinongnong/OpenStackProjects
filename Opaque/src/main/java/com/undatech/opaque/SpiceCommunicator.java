...
//	}
        ...
        thread = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    File vv = new File(certsDir, "jz.vv");
                    certsDir.mkdirs();

                    GStreamer.copyFile(assetManager, "ssl/certs/console_2.vv", vv);
                    String vvPath = vv.getAbsolutePath();

                    startSessionFromVvFile(vvPath, true);
    ...
    class OvirtThread extends Thread {
        ...
        public void run() {
            ...
            Log.e(TAG, "CreateOvirtSession returned.");
    ...
    public void writeKeyEvent(int key, int metaState, boolean keyDown) {
        ...
        Log.e("SpiceCommunicator", "Sending scanCode: " + key + ". Is it down: " + keyDown);
        ...
        if (isInNormalProtocol) {
            ...
            if (isRequestingNewDisplayResolution) {
                ...
                if (currentWidth != desiredWidth || currentHeight != desiredHeight) {
                    Log.e(TAG, "Requesting new res: " + desiredWidth + "x" + desiredHeight);
